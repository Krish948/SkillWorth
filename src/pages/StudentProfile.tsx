  ...
  return (
    <div className="space-y-6 animate-fade-in page-shell">
          ...
          <Card className="max-w-md w-full panel-soft border-primary/50">
            <CardHeader>
              <CardTitle className="text-xl font-display flex items-center gap-2">
                <ShieldCheck className="w-6 h-6 text-primary" /> Technical Skill Validation
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-xs">
              <p className="text-muted-foreground">
                Confirm validation assessment for <strong>{validatingSkillName}</strong>. Demonstrating core code proficiency upgrades this skill from Self-Declared to <strong>VERIFIED</strong>.
              </p>
      ...
      <Dialog open={settingsOpen} onOpenChange={setSettingsOpen}>
        <DialogContent className="sm:max-w-md panel-soft">
          <DialogHeader>
          ...
          <div className="space-y-4 pt-2 text-xs">
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2 rounded-xl border border-border/60 bg-muted/40 px-3 py-2 text-muted-foreground">
